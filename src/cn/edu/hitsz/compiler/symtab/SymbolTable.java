...
public class SymbolTable {
    private List<SymbolTableEntry> symbolTableEntries = new ArrayList<>();
    /**
     * 获取符号表中已有的条目
     *
     * @param text 符号的文本表示
    ...
    public SymbolTableEntry get(String text) {
        for( SymbolTableEntry i : symbolTableEntries){
    ...
    public SymbolTableEntry add(String text) {
        SymbolTableEntry newSymbolTableEntry = new SymbolTableEntry(text);
        if (symbolTableEntries.contains(newSymbolTableEntry)){
            throw new RuntimeException();
        }
        else {
            symbolTableEntries.add(newSymbolTableEntry);
    ...
    private Map<String, SymbolTableEntry> getAllEntries() {
        Map<String, SymbolTableEntry> symbleTableMap= new HashMap<String,SymbolTableEntry>();
        for( SymbolTableEntry i : symbolTableEntries){
            symbleTableMap.put(i.getText(),i);
        }
